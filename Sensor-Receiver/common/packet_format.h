 ...
 * 2. link_metadata_t (12 Byte) - LoRa/ESP-NOW Metadaten
...
/* ============================================================================
 * Layer 2: Link Metadata (12 bytes) - Transport-specific info
 * ============================================================================ */
...
typedef struct __attribute__((packed)) {
    ...
    link_metadata_t link;           // 12 bytes - transport metadata
...
#define PACKET_METADATA_SIZE  sizeof(link_metadata_t)     // 16 bytes (added msg_source)
