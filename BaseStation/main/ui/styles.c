...
void init_style_dropdown_INDICATOR_DEFAULT(lv_style_t *style) {
...
lv_style_t *get_style_dropdown_INDICATOR_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_dropdown_INDICATOR_DEFAULT(style);
    }
    return style;
};
...
void add_style_dropdown(lv_obj_t *obj) {
    ...
    lv_obj_add_style(obj, get_style_dropdown_INDICATOR_DEFAULT(), LV_PART_INDICATOR | LV_STATE_DEFAULT);
};
...
void remove_style_dropdown(lv_obj_t *obj) {
    ...
    lv_obj_remove_style(obj, get_style_dropdown_INDICATOR_DEFAULT(), LV_PART_INDICATOR | LV_STATE_DEFAULT);
};
...
void init_style_dropdown_list_MAIN_DEFAULT(lv_style_t *style) {
    lv_style_set_text_font(style, &ui_font_free_sans30);
};
...
lv_style_t *get_style_dropdown_list_MAIN_DEFAULT() {
    ...
    if (!style) {
        style = (lv_style_t *)lv_malloc(sizeof(lv_style_t));
        lv_style_init(style);
        init_style_dropdown_list_MAIN_DEFAULT(style);
    }
    return style;
};
...
void add_style_dropdown_list(lv_obj_t *obj) {
    (void)obj;
    lv_obj_add_style(obj, get_style_dropdown_list_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};

void remove_style_dropdown_list(lv_obj_t *obj) {
    (void)obj;
    lv_obj_remove_style(obj, get_style_dropdown_list_MAIN_DEFAULT(), LV_PART_MAIN | LV_STATE_DEFAULT);
};
